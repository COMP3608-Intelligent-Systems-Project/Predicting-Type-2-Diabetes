...
| **Experiment 3 - Feature Importance Analysis** | Extract feature importance from tuned LightGBM and XGBoost models. Determine whether clinical features (HbA1c, glucose) consistently outrank lifestyle features (physical activity, diet) across datasets. Includes univariate analysis, K-Fold stability testing and top k-features comparison analysis |
